...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _shared_script__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./shared_script */ \"./src/shared_script.js\");\n/* harmony import */ var _shared_script__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_shared_script__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _bgLazyLoad__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./bgLazyLoad */ \"./src/bgLazyLoad.js\");\n\n\n\nvar main = document.querySelector(\"main\");\nvar planetPic = document.getElementById(\"planet-pic\");\nvar planetName = document.getElementById(\"planet-name\");\nvar aboutPlanet = document.getElementById(\"about-planet\");\nvar travelDistance = document.getElementById(\"travel-distance\");\nvar travelTime = document.getElementById(\"travel-time\");\nvar tabs = document.querySelectorAll(\"[data-tab]\"); // LOAD JSON FROM data.json && SHOW ON GUI\n\nvar requestURL = \"./data.json\";\nvar request = new XMLHttpRequest();\nrequest.open(\"GET\", requestURL);\nrequest.responseType = \"json\";\nrequest.send();\n\nrequest.onload = function () {\n  var data = request.response;\n  var planetData = data.destinations;\n  showDatas(planetData, 0);\n  tabs.forEach(function (tab, index) {\n    tab.addEventListener(\"click\", function () {\n      removeBorders(tabs);\n      addBorder(tab);\n      showDatas(planetData, index);\n    });\n  });\n};\n\nfunction showDatas(data, index) {\n  var _data$index$images$pn, _data$index$name, _data$index$descripti, _data$index$distance, _data$index$travel;\n\n  planetPic.src = (_data$index$images$pn = data[index].images.png) !== null && _data$index$images$pn !== void 0 ? _data$index$images$pn : \"error\";\n  planetName.innerText = (_data$index$name = data[index].name) !== null && _data$index$name !== void 0 ? _data$index$name : \"error\";\n  aboutPlanet.innerText = (_data$index$descripti = data[index].description) !== null && _data$index$descripti !== void 0 ? _data$index$descripti : \"error\";\n  travelDistance.innerText = (_data$index$distance = data[index].distance) !== null && _data$index$distance !== void 0 ? _data$index$distance : \"error\";\n  travelTime.innerText = (_data$index$travel = data[index].travel) !== null && _data$index$travel !== void 0 ? _data$index$travel : \"error\";\n}\n\nfunction removeBorders(els) {\n  els.forEach(function (el) {\n    el.classList.remove(\"border-b-2\");\n    el.classList.remove(\"border-white\");\n  });\n}\n\nfunction addBorder(el) {\n  el.classList.add(\"border-b-2\");\n  el.classList.add(\"border-white\");\n}\n\n//# sourceURL=webpack://space-tourism-website/./src/destination.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/destination.js");
/******/ 	
/******/ })()
;